...
```bash
conda create -n alphaagent python=3.11
conda activate alphaagent
```

### 2. 安装本仓库

在 **AlphaAgent 根目录** 下安装依赖与可编辑包：
...
alphaagent mine --direction "你的市场假说，例如：行为金融学假说"
```
...
```bash
# 跑 1 轮
alphaagent mine --direction "行为金融学假说" --step_n 5

# 跑 2 轮
alphaagent mine --direction "行为金融学假说" --step_n 10
```
