...
from alphapilot.components.coder.model_coder.model import ModelExperiment, ModelTask
from alphapilot.components.document_reader.document_reader import (
    load_and_process_pdfs_by_langchain,
)
from alphapilot.components.loader.task_loader import ModelTaskLoader
...
def extract_model_from_doc(doc_content: str) -> dict:
    ...
    session = get_llm().chat_session(
        document_process_prompts["extract_model_formulation_system"],
    )
