...
alphapilot_evaluate_prompts = Prompts(file_path=Path(__file__).parent / "prompts_alphapilot.yaml")
    ...
    def evaluate(
        ...
        **kwargs,
        ...
        system_prompt = (
            ...
            .from_string(alphapilot_evaluate_prompts["evaluator_code_feedback_v1_system"])
            .render(
                scenario=(
        ...
        for _ in range(10):  # 10 times to split the content is enough
            user_prompt = (
                Environment(undefined=StrictUndefined)
                .from_string(
                    alphapilot_evaluate_prompts["evaluator_code_feedback_v1_user"],
                )
                .render(
            ...
            if (
                ...
                break
        critic_response = get_llm().chat_completion(
            user_prompt=user_prompt,
            system_prompt=system_prompt,
            json_mode=False,
