...
# from alphapilot.scenarios.kaggle.experiment.scenario import KGScenario
...
# 设置页面配置
st.set_page_config(layout="wide", page_title="AlphaPilot", page_icon="🎓", initial_sidebar_state="expanded")
...
SIMILAR_SCENARIOS = (QlibAlphaPilotScenario, QlibModelScenario, QlibModelScenario, QlibFactorScenario, QlibFactorFromReportScenario)
