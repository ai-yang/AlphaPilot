...
def cache_with_pickle(
    ...
    When *cache_if* is set, only results passing the predicate are written to cache.
    Stale cache entries that fail *cache_if* on read are removed and the function is re-run.
    """
    ...
    def cache_decorator(func: Callable) -> Callable:
        ...
        def cache_wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            if cache_file.exists():
                ...
                if cache_if is None or cache_if(cached_res):
